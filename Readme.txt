...
this.Play() returns a CoroutineHandle.  Hang on to that if you want to be able to stop that coroutine from playing.  This is not Unity's Coroutine system, but a 3rd party library called More Effective Coroutines (MEC)  More info including full documentation can be found at:  http://trinary.tech/category/mec/
